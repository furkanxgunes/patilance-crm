...
@section('title', 'Randevu Check-in')

@section('plugins.Summernote', true)

@section('content_header')
    <div class="mb-3">
        <h1 class="mb-2">Check-in - Randevu #{{ $appointment->id }}</h1>
        @php
            $breadcrumbs = [
...
@section('content')
<div class="row" x-data="{ step: 1 }" x-cloak>
    <div class="col-12 col-lg-10 mx-auto">
        ...
        <x-adminlte-callout theme="info" title="Adımlar">
            <div class="d-flex flex-wrap gap-2 justify-content-center">
                ...
                <button type="button" class="btn btn-sm m-1" :class="step===2 ? 'btn-primary' : 'btn-outline-primary'" disabled>2. Hizmetler</button>
                <button type="button" class="btn btn-sm m-1" :class="step===3 ? 'btn-primary' : 'btn-outline-primary'" disabled>3. Notlar</button>
                <button type="button" class="btn btn-sm m-1" :class="step===4 ? 'btn-primary' : 'btn-outline-primary'" disabled>4. Onay</button>
            </div>
        </x-adminlte-callout>
        ...
        <form action="{{ route('appointments.checkin', $appointment) }}" method="POST">
            ...
            <div x-show="step===1" x-transition.opacity>
                <x-adminlte-card title="Check-in Zamanı" theme="primary" icon="fas fa-clock">
                    <div class="row"> 
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ optional($appointment->planned_at)->format('d.m.Y H:i') }}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="button" class="btn btn-primary" @click="step=2">Devam</button>
                    </div>
                </x-adminlte-card>
            </div>
            ...
            <div x-show="step===3" x-transition.opacity>
                <x-adminlte-card title="Sahip Notları / Özel İstekler" theme="primary" icon="fas fa-sticky-note">
                    ...
                    @error('owner_requests')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-secondary" @click="step=2">Geri</button>
                        <button type="button" class="btn btn-primary" @click="step=4">Devam</button>
                    </div>
                </x-adminlte-card>
            </div>
