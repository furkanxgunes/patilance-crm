...
return [
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/patilance_logo.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'preloader' => [
        ...
        'mode' => 'fullscreen',
        'img' => [
            'path' => 'vendor/adminlte/dist/img/patilance-logo-kare.png',
    ...
    */
    ...
    'classes_content_header' => 'pl-0',
    'classes_content' => '',
    'classes_breadcrumb' => 'breadcrumb',
    ...
    */
    ...
    'menu' => [
        ...
        [
        'text' => 'Müşteri Yönetimi', // Ana menü başlığı
        'icon' => 'fas fa-fw fa-users',
        // 'can'  => 'manage-services', // İsteğe bağlı olarak yetkilendirme (authorization) için kullanılır
        'submenu' => [
            [
                'text' => 'Müşteriler',
                'url'  => 'customers', // veya 'route' => 'services.index'
                'icon' => 'fas fa-fw fa-list',
            ],
            [
        ...
        'submenu' => [
            ...
            [
                'text' => 'Yeni Pet Ekle',
                'url'  => 'pets/create', // veya 'route' => 'services.create'
                'icon' => 'fas fa-fw fa-plus-circle',
            ],
        ],
        ],
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Kullanıcılar',
                    'url'  => 'users', // veya 'route' => 'services.index'
                    'icon' => 'fas fa-fw fa-list',
                ],
                [
                    'text' => 'Kullanıcı Oluştur',
                    'url'  => 'users/create', // veya 'route' => 'services.create'
                    'icon' => 'fas fa-fw fa-plus-circle',
                ],
            ],
            ],
            [
                ...
                'submenu' => [
                    [
                        'text' => 'Hizmet Analizi',
                        'url'  => 'raporlar/hizmet-analizi',
                        'icon' => 'fas fa-chart-pie',
                    ],
                    [
                        'text' => 'Ciro Raporu',
                        'url'  => 'raporlar/ciro-raporu',
                        'icon' => 'fas fa-money-bill-wave',
                    ],
                    [
                        'text' => 'Müşteri Analizi',
                        'url'  => 'raporlar/musteri-analizi',
                        'icon' => 'fas fa-users',
                    ],
                ],
            ],
